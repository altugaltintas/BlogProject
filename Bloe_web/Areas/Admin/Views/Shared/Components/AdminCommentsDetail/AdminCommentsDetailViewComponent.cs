...
namespace Bloe_web.Areas.Admin.Views.Shared.Components.AdminCommentsDetail
{
    public class AdminCommentsDetailViewComponent : ViewComponent
    {

        private readonly ICommentRepo _commentRepo;
        private readonly UserManager<AppUser> _userManager;

        public AdminCommentsDetailViewComponent(ICommentRepo commentRepo, UserManager<AppUser> userManager)
        {
